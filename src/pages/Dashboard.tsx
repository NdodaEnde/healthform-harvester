...
const Dashboard = () => {
  ...
  if (authLoading || orgLoading) {
    return (
      <DashboardLayout>
        {/* REMOVE: Any container div or space-y classes that add margin */}
        <div className="h-full w-full">
          ...
          <FeatureSkeleton type="card" className="h-32 mb-6" />
  ...
  return (
    <DashboardLayout>
      {/* CRITICAL FIX: Remove the outer div with space-y-8 that was adding margin */}
      {/* The DashboardLayout already provides proper spacing with px-4 md:px-8 */}
