...
const renderExaminationFields = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Certificate Header */}
      <div className="bg-slate-800 text-white text-center p-3 rounded-t-lg">
        <h2 className="text-xl font-bold">CERTIFICATE OF FITNESS</h2>
      </div>

      {/* Moved Doctor Info into Patient Information section to save space */}
      <div className="space-y-3 border p-3 rounded-lg bg-gray-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div className="flex items-center">
            <Label htmlFor="exam_date" className="min-w-32 font-bold">Date of Exam:</Label>
            <Input
              id="exam_date"
              value={certification.examination_date || ''}
              onChange={(e) => updateField('certification', 'examination_date', e.target.value)}
        ...
        {/* Doctor info moved to end of patient section */}
        <div className="flex items-center">
          <Label htmlFor="doctor_info" className="min-w-32 font-bold">Doctor Info:</Label>
          <Input
            id="doctor_info"
      ...
      {/* Examination Type - more compact */}
      <div className="border rounded-lg overflow-hidden">
        <div className="grid grid-cols-3 gap-0 border-b">
          <div className="border-r p-2 font-bold text-center bg-gray-100">PRE-EMPLOYMENT</div>
          <div className="border-r p-2 font-bold text-center bg-gray-100">PERIODICAL</div>
          <div className="p-2 font-bold text-center bg-gray-100">EXIT</div>
        </div>
      ...
      {/* Medical Tests Section - more compact */}
      <div>
        <div className="bg-slate-800 text-white text-center p-2 rounded-t-lg">
          <h2 className="text-lg font-bold">MEDICAL EXAMINATION TESTS</h2>
        </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gray-100">
                  ...
                  <th className="p-1 text-center border-r w-1/6">Done</th>
      ...
      {/* Follow up and Review date - more compact */}
      <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
        <div className="md:col-span-3">
          <Label htmlFor="follow_up" className="font-bold block mb-1">Referred or follow up actions:</Label>
          <Input
            id="follow_up"
            value={certification.follow_up || ''}
            onChange={(e) => updateField('certification', 'follow_up', e.target.value)}
        ...
        <div>
          <Label htmlFor="review_date" className="font-bold block mb-1">Review Date:</Label>
          <Input
            id="review_date"
            value={certification.review_date || ''}
            onChange={(e) => updateField('certification', 'review_date', e.target.value)}
      ...
      <div>
        ...
        <div className="mt-3 border rounded-lg overflow-hidden">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-0">
            <div className={cn("p-2 flex flex-col items-center justify-start border-r border-b", {
              "bg-yellow-50": restrictions.heights
            })}>
              <span className="font-bold mb-1 text-sm">Heights</span>
              <Checkbox 
            ...
            <div className={cn("p-2 flex flex-col items-center justify-start border-r border-b", {
              ...
              <span className="font-bold mb-1 text-sm">Dust Exposure</span>
              <Checkbox 
            ...
            <div className={cn("p-2 flex flex-col items-center justify-start border-r border-b", {
              ...
              <span className="font-bold mb-1 text-sm">Motorized Equipment</span>
              <Checkbox 
            ...
            <div className={cn("p-2 flex flex-col items-center justify-start border-b", {
              "bg-yellow-50": restrictions.hearing_protection
            })}>
              <span className="font-bold mb-1 text-sm">Wear Hearing Protection</span>
              <Checkbox 
            ...
            <div className={cn("p-2 flex flex-col items-center justify-start border-r", {
              "bg-yellow-50": restrictions.confined_spaces
            })}>
              <span className="font-bold mb-1 text-sm">Confined Spaces</span>
              <Checkbox 
            ...
            <div className={cn("p-2 flex flex-col items-center justify-start border-r", {
              ...
              <span className="font-bold mb-1 text-sm">Chemical Exposure</span>
              <Checkbox 
            ...
            <div className={cn("p-2 flex flex-col items-center justify-start border-r", {
              ...
              <span className="font-bold mb-1 text-sm">Wear Spectacles</span>
              <Checkbox 
            ...
            <div className={cn("p-2 flex flex-col items-center justify-start", {
              "bg-yellow-50": restrictions.chronic_treatment
            })}>
              <span className="font-bold mb-1 text-sm text-center">Treatment for Chronic Conditions</span>
              <Checkbox 
      ...
      {/* Fitness Assessment - more compact */}
      <div>
        <div className="bg-slate-800 text-white text-center p-2 rounded-t-lg">
          <h2 className="text-lg font-bold">FITNESS ASSESSMENT</h2>
        </div>
        
        <div className="mt-3 border rounded-lg overflow-hidden">
          <div className="grid grid-cols-5 gap-0">
            <div className={cn("p-2 flex flex-col items-center justify-center border-r", {
              "bg-green-100": certification.fit
            })}>
              <span className="font-bold mb-1 text-sm">FIT</span>
              <Checkbox 
            ...
            <div className={cn("p-2 flex flex-col items-center justify-center border-r", {
              ...
              <span className="font-bold mb-1 text-sm text-center">Fit with Restriction</span>
              <Checkbox 
            ...
            <div className={cn("p-2 flex flex-col items-center justify-center border-r", {
              ...
              <span className="font-bold mb-1 text-sm text-center">Fit with Condition</span>
              <Checkbox 
            ...
            <div className={cn("p-2 flex flex-col items-center justify-center border-r", {
              ...
              <span className="font-bold mb-1 text-sm text-center">Temporary Unfit</span>
              <Checkbox 
            ...
            <div className={cn("p-2 flex flex-col items-center justify-center", {
              "bg-red-100": certification.unfit
            })}>
              <span className="font-bold mb-1 text-sm">UNFIT</span>
              <Checkbox 
      ...
      {/* Doctor Signature - now more compact */}
      <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <Label htmlFor="doctor_signature" className="font-bold block mb-1 text-sm">Doctor Signature:</Label>
          <div className="h-16 border border-dashed border-gray-300 rounded flex items-center justify-center text-gray-500 text-sm">
            Signature Area
          </div>
        </div>
        <div>
          <Label htmlFor="doctor_stamp" className="font-bold block mb-1 text-sm">Doctor Stamp:</Label>
          <div className="h-16 border border-dashed border-gray-300 rounded flex items-center justify-center text-gray-500 text-sm">
            Stamp Area
          </div>
        </div>
