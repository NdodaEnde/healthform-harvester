...
interface CertificateValidatorProps {
  ...
  onCancel: () => void;
  initialData?: any; // Add initialData prop as optional
}
...
const CertificateValidator = ({
  ...
  onSave,
  onCancel,
  initialData, // Add initialData to destructured props
}: CertificateValidatorProps) => {
  const [validatedData, setValidatedData] = useState(() => {
    // Use initialData if provided, otherwise use extractedData
