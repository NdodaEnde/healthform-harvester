      ...
      <Card className="border-0 shadow-none bg-white w-full max-w-3xl mx-auto font-sans text-black">
        <div className="relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="bg-gray-800 text-white text-center py-[2px] text-[0.6rem]">
              <p className="leading-tight">This certificate was electronically generated by BlueCollar Occupational Health Services.</p>
              <p className="leading-tight">© {new Date().getFullYear()} BlueCollar Health & Wellness</p>
            </div>
          </div>
        </div>
      </Card>
