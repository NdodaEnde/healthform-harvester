...
const CertificateTemplate = ({
  ...
  useEffect(() => {
    ...
    // Ensure we're using a deep copy to avoid reference issues
    setLocalData(JSON.parse(JSON.stringify(extractedData)));
  }, [extractedData]);
  ...
  // Extract the rest of the data from the structuredData
  const fitnessStatus = {
      ...
      <Card className="border-0 shadow-none bg-white w-full max-w-3xl mx-auto font-sans text-black">
        <div className="relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="mb-4">
              ...
              <div className="px-4">
                <table className="w-full border border-gray-400">
                  <tbody>
                    <tr>
                      <td className="border border-gray-400 px-3 py-2 w-2/3">
                        <div className="flex items-center">
                          <div className="mr-2">
                            {isEditable ? (
                              <Checkbox 
                          ...
                          <div className="font-semibold">FIT</div>
                        </div>
                      </td>
                      <td className="border border-gray-400 px-3 py-2">
                        <div className="flex items-center">
                          ...
                          <div className="font-semibold">UNFIT</div>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-gray-400 px-3 py-2">
                        <div className="flex items-center">
                          ...
                          <div className="font-semibold">Fit with Restriction</div>
                        </div>
                      </td>
                      <td className="border border-gray-400 px-3 py-2">
                        <div className="flex items-center">
                          ...
                          <div className="font-semibold">Temporary Unfit</div>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-gray-400 px-3 py-2" colSpan={2}>
                        <div className="flex items-center">
                          ...
                          <div className="font-semibold">Fit with Condition</div>
                        </div>
                      </td>
                    </tr>
                  </tbody>
                  ...
                  <div>
                    ...
                    <div className="mb-2">
                      <div className="flex items-center">
                        ...
                        <div>Wear Hearing Protection</div>
                      </div>
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="mb-2">
                      <div className="flex items-center">
                        ...
                        <div>Remain on Treatment for Chronic Conditions</div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="px-4 mb-4">
              <div className="mb-3">
                <label className="block text-sm font-medium mb-1">Referred or follow up actions:</label>
                {isEditable ? (
                  <Textarea
                  ...
                  <p className="border p-2 rounded text-sm">{getValue(certification, 'follow_up', 'N/A')}</p>
                )}
              </div>
              ...
              <div className="mb-3">
                ...
                {isEditable ? (
                  ...
                  <p className="border p-2 rounded text-sm">{getValue(certification, 'review_date', 'N/A')}</p>
                )}
              </div>
              ...
              <div className="mb-4">
                ...
                {isEditable ? (
                  ...
                  <p className="border p-2 rounded text-sm">{getValue(certification, 'comments', 'N/A')}</p>
                )}
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 gap-8">
                <div>
                  <div className="border-t border-gray-400 pt-1 text-center">
                    Dr. {getValue(examination, 'physician') || getValue(certification, 'certifying_physician') || 'MJ Mphuthi'}
                  </div>
