  ...
  public: {
    Tables: {
      ...
      my_documents: {
        ...
        Relationships: [
          {
            foreignKeyName: "my_documents_document_type_id_fkey"
            columns: ["document_type_id"]
            isOneToOne: false
            referencedRelation: "my_document_types"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "my_documents_patient_id_fkey"
            columns: ["patient_id"]
            isOneToOne: false
            referencedRelation: "my_patients"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "my_documents_uploaded_by_fkey"
            columns: ["uploaded_by"]
            isOneToOne: false
            referencedRelation: "my_users"
            referencedColumns: ["id"]
          },
        ]
      }
      my_organization_relationships: {
        Row: {
          client_id: string
          created_at: string | null
          id: string
        ...
        Relationships: [
          {
            foreignKeyName: "my_organization_relationships_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "my_organization_relationships_service_provider_id_fkey"
      ...
      my_organizations: {
        ...
        Relationships: [
          {
            foreignKeyName: "my_organizations_organization_type_id_fkey"
            columns: ["organization_type_id"]
            isOneToOne: false
            referencedRelation: "my_organization_types"
            referencedColumns: ["id"]
          },
        ]
      }
      my_patients: {
        ...
        Relationships: [
          {
            foreignKeyName: "my_patients_client_organization_id_fkey"
            columns: ["client_organization_id"]
            isOneToOne: false
            referencedRelation: "my_organizations"
            referencedColumns: ["id"]
      ...
      my_users: {
        ...
        Relationships: [
          {
            foreignKeyName: "my_users_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "my_organizations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "my_users_user_type_id_fkey"
            columns: ["user_type_id"]
            isOneToOne: false
            referencedRelation: "my_user_types"
            referencedColumns: ["id"]
          },
        ]
      }
